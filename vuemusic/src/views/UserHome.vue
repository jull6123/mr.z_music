    ...
    <el-header>
      <template #default="scope">
        ...
        <div class="audio audioButton" style="left: 1420px">
          <el-button style="width: 80px" @click="changeMode">
              ...
              <el-card class="box-card" :style="{ height: '400px' }" style="margin-top: 10px;opacity: 85%">
                ...
                <el-table :data="mymusicALL" border stripe :header-cell-class-name="'headerBg'"
                  ...
                  <el-table-column label="操作" width="500" align="center">
                    <template #default="scope">
<!--                      均可播放-->
                      <el-button @click="display(scope.row);display2(scope.row.index+1)"><el-icon><VideoPlay /></el-icon></el-button>
<!--                      未上传可修改，上传，，其他只可查看-->
...
<!--                      上传成功的-->
                      <el-button type="success" v-if="scope.row.is_upload === 3" @click="comment(scope.row)"><el-icon style="font-size: 24px"><Comment /></el-icon> </el-button>
            ...
            <div style="margin: 10px 0;opacity: 85%" v-if="getType==='songList'">
              ...
              <el-card class="box-card" :style="{ height: '400px' }">
                ...
                <el-table :data="songListMine" border stripe :header-cell-class-name="'headerBg'">
                  ...
                  <el-table-column label="操作" width="500" align="center">
                    <template #default="scope">
                      <el-button style="border: none" v-if="scope.row.is_upload !== 2" @click="getSongMusic(scope.row);display2(scope.row.index+1)"> 播放并查看 </el-button>
...
<!--            我听过的-->
            <div style="margin: 10px 0;opacity: 85%" v-if="getType==='listened'">
              ...
              <el-table :data="musicListened" border stripe :header-cell-class-name="'headerBg'">
                ...
                <el-table-column label="操作" width="500" align="center">
                  <template #default="scope">
                    <el-button style="border: none" @click="display(scope.row);display2(scope.row.index+1)"><el-icon style="font-size: 20px"><VideoPlay /></el-icon></el-button>
                  </template>
                </el-table-column>
              </el-table>
            </div>
                ...
                <div>
                  ...
                  <el-card class="box-card" :style="{ height: '300px' }" style="margin-top: 30px">
                    ...
                    <el-table :data="commentHot" border stripe :header-cell-class-name="'headerBg'">
                      ...
                      <el-table-column label="操作" width="500" align="center">
                        <template #default="scope">
                          <el-button type="primary" @click="opencomment(scope.row.id)"><el-icon><Comment /></el-icon></el-button>
                  ...
                  <el-card class="box-card" style="height: 350px;">
                    ...
                    <el-table :data="commentHot" border stripe :header-cell-class-name="'headerBg'">
                      ...
                      <el-table-column label="操作" width="500" align="center">
                        <template #default="scope">
                          <el-button @click="opencomment(scope.row.id)"><el-icon><Comment /></el-icon></el-button>
                          <el-button type="primary" @click="like(scope.row,'comment')"> 点赞 </el-button>
                          <el-button type="primary" v-if="scope.row.user_id === user.id" @click="delAnyById('comment', scope.row.id)"> 删除 </el-button>
                        </template>
                      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    display2(index)
    {
      ...
      this.MusicUrl = this.musicListAll[index-1].url
