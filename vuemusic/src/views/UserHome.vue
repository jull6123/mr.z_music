      ...
      <el-row class="grid-content bg-black-light head-button" :gutter="16">
        ...
        <el-col :span="1" style="text-align: center">
          <el-dropdown trigger="click">
            <h3 class="el-dropdown-link mx-1" size="large" type="text" style="margin-top: 24px;font-size: 18px">{{ user.username }}</h3>
            <template #dropdown>
              <el-dropdown-menu>
...
<!--              搜索框              -->
              <el-card class="box-card" :style="{ height: '80px' }">
                ...
                <el-input style="width: 300px" placeholder="输入喜欢的音乐，实现你的音乐梦想" suffix-icon="el-icon-message" class="ml-5"
